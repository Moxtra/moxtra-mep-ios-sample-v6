...
@implementation MEPLoginViewController
...
- (id)init
{
    ...
    if (self) {
        ...
        [[MEPClient sharedInstance] setupWithDomains:MOXTRA_DOMAIN httpsDomain:nil wssDomain:nil linkConfig:nil];
...
#ifdef CALABASH
		self.sessionExpireInterval = 300;
#endif
